...
Implement **Topic 5 — System Principles and Non-Negotiable Rules** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_05.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_05.md` (Topic 5 — System Principles and Non-Negotiable Rules)
...
Implement **only** Topic 5 as specified in `srs/topics/TOPIC_05.md`. Do
...
- All Topic 5 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 5 requirement implemented (no silent omissions).
...
```text
feature/topic-05-system-principles
```
...
```text
feat(topic-05): <concise description>
```

...
Implement **Topic 37 — Security and Secrets Management** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_37.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_37.md` (Topic 37 — Security and Secrets Management)
...
Implement **only** Topic 37 as specified in `srs/topics/TOPIC_37.md`. Do
...
- All Topic 37 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 37 requirement implemented (no silent omissions).
...
```text
feature/topic-37-security-secrets
```
...
```text
feat(topic-37): <concise description>
```

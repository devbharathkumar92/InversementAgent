...
Implement **Topic 17 — Backtesting and Simulation** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_17.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_17.md` (Topic 17 — Backtesting and Simulation)
...
Implement **only** Topic 17 as specified in `srs/topics/TOPIC_17.md`. Do
...
- All Topic 17 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 17 requirement implemented (no silent omissions).
...
```text
feat(topic-17): <concise description>
```

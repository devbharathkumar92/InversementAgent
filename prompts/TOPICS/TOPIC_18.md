...
Implement **Topic 18 — Paper Trading Engine** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_18.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_18.md` (Topic 18 — Paper Trading Engine)
...
Implement **only** Topic 18 as specified in `srs/topics/TOPIC_18.md`. Do
...
- All Topic 18 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 18 requirement implemented (no silent omissions).
...
```text
feature/topic-18-paper-trading
```
...
```text
feat(topic-18): <concise description>
```

...
> Phase 4 — Trading / Investment Simulation & Safety
...
Implement **Topic 20 — Monitoring and P&L Management** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_20.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_20.md` (Topic 20 — Monitoring and P&L Management)
...
Implement **only** Topic 20 as specified in `srs/topics/TOPIC_20.md`. Do
...
- All Topic 20 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 20 requirement implemented (no silent omissions).
...
```text
feature/topic-20-monitoring-pnl
```
...
```text
feat(topic-20): <concise description>
```

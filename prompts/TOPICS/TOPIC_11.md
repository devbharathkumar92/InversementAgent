...
Implement **Topic 11 — Data Validation and Quality Layer** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_11.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_11.md` (Topic 11 — Data Validation and Quality Layer)
...
Implement **only** Topic 11 as specified in `srs/topics/TOPIC_11.md`. Do
...
- All Topic 11 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 11 requirement implemented (no silent omissions).
...
```text
feature/topic-11-data-validation-quality
```
...
```text
feat(topic-11): <concise description>
```

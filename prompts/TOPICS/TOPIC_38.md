...
Implement **Topic 38 — PoV Release Criteria** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_38.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_38.md` (Topic 38 — PoV Release Criteria)
...
| TOPIC_36 — Integration and Deployment | hard | see PROJECT_STATUS.md |
| TOPIC_37 — Security and Secrets Management | hard | see PROJECT_STATUS.md |
...
Implement **only** Topic 38 as specified in `srs/topics/TOPIC_38.md`. Do
...
- All Topic 38 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 38 requirement implemented (no silent omissions).
...
```text
feature/topic-38-pov-release-criteria
```
...
```text
feat(topic-38): <concise description>
```

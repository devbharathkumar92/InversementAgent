...
Implement **Topic 35 — Definition of Done** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_35.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_35.md` (Topic 35 — Definition of Done)
...
Implement **only** Topic 35 as specified in `srs/topics/TOPIC_35.md`. Do
...
- All Topic 35 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 35 requirement implemented (no silent omissions).
...
```text
feature/topic-35-definition-of-done
```
...
```text
feat(topic-35): <concise description>
```

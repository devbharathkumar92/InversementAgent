...
Implement **Topic 24 — Error Detection and Recovery** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_24.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_24.md` (Topic 24 — Error Detection and Recovery)
...
Implement **only** Topic 24 as specified in `srs/topics/TOPIC_24.md`. Do
...
- All Topic 24 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 24 requirement implemented (no silent omissions).
...
```text
feature/topic-24-error-management
```
...
```text
feat(topic-24): <concise description>
```

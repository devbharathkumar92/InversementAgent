...
Implement **Topic 22 — Human Interaction and Notifications** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_22.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_22.md` (Topic 22 — Human Interaction and Notifications)
...
Implement **only** Topic 22 as specified in `srs/topics/TOPIC_22.md`. Do
...
- All Topic 22 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 22 requirement implemented (no silent omissions).
...
```text
feature/topic-22-human-interaction
```
...
```text
feat(topic-22): <concise description>
```

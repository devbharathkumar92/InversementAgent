...
Implement **Topic 25 — Self-Evaluation** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_25.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_25.md` (Topic 25 — Self-Evaluation)
...
Implement **only** Topic 25 as specified in `srs/topics/TOPIC_25.md`. Do
...
- All Topic 25 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 25 requirement implemented (no silent omissions).
...
```text
feature/topic-25-self-evaluation
```
...
```text
feat(topic-25): <concise description>
```

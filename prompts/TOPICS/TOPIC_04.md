...
Implement **Topic 4 — System Scope and Boundaries** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_04.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_04.md` (Topic 4 — System Scope and Boundaries)
...
Implement **only** Topic 4 as specified in `srs/topics/TOPIC_04.md`. Do
...
- All Topic 4 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 4 requirement implemented (no silent omissions).
...
```text
feature/topic-04-system-scope-and-boundaries
```
...
```text
feat(topic-04): <concise description>
```

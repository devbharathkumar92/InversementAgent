...
Implement **Topic 30 — Sub-Agent Task Specification** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_30.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_30.md` (Topic 30 — Sub-Agent Task Specification)
...
Implement **only** Topic 30 as specified in `srs/topics/TOPIC_30.md`. Do
...
- All Topic 30 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 30 requirement implemented (no silent omissions).
...
```text
feature/topic-30-sub-agent-task-spec
```
...
```text
feat(topic-30): <concise description>
```

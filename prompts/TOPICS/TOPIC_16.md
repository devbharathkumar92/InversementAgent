...
Implement **Topic 16 — Risk and Safety Engine** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_16.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_16.md` (Topic 16 — Risk and Safety Engine)
...
Implement **only** Topic 16 as specified in `srs/topics/TOPIC_16.md`. Do
...
- All Topic 16 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 16 requirement implemented (no silent omissions).
...
```text
feat(topic-16): <concise description>
```

...
Implement **Topic 36 — Integration and Deployment** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_36.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_36.md` (Topic 36 — Integration and Deployment)
...
| TOPIC_27 — SRS Version Control and Governance | hard | see PROJECT_STATUS.md |
| TOPIC_28 — Requirement Traceability | hard | see PROJECT_STATUS.md |
| TOPIC_29 — Sub-Agent Architecture | hard | see PROJECT_STATUS.md |
| TOPIC_30 — Sub-Agent Task Specification | hard | see PROJECT_STATUS.md |
| TOPIC_31 — Dependency and Execution Plan | hard | see PROJECT_STATUS.md |
| TOPIC_32 — Parallel Development Plan | hard | see PROJECT_STATUS.md |
| TOPIC_33 — Testing Strategy | hard | see PROJECT_STATUS.md |
| TOPIC_34 — SRS Self-Validation | hard | see PROJECT_STATUS.md |
| TOPIC_35 — Definition of Done | hard | see PROJECT_STATUS.md |
...
Implement **only** Topic 36 as specified in `srs/topics/TOPIC_36.md`. Do
...
- All Topic 36 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 36 requirement implemented (no silent omissions).
...
```text
feature/topic-36-integration-deployment
```
...
```text
feat(topic-36): <concise description>
```

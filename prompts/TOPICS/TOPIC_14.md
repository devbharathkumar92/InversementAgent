...
Implement **Topic 14 — Opportunity Scoring Engine** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_14.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_14.md` (Topic 14 — Opportunity Scoring Engine)
...
Implement **only** Topic 14 as specified in `srs/topics/TOPIC_14.md`. Do
...
- All Topic 14 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 14 requirement implemented (no silent omissions).
...
```text
feature/topic-14-opportunity-scoring
```
...
```text
feat(topic-14): <concise description>
```

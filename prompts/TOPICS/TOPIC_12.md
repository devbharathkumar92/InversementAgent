...
Implement **Topic 12 — Opportunity Discovery Engine** in full, consistent with the authoritative
requirements in `srs/topics/TOPIC_12.md` and the governance rules in
`MASTER.md`, without silently altering any frozen requirement or implementing
future topics.

## SRS Requirements Covered

`srs/topics/TOPIC_12.md` (Topic 12 — Opportunity Discovery Engine)
...
Implement **only** Topic 12 as specified in `srs/topics/TOPIC_12.md`. Do
...
- All Topic 12 requirements implemented, validated, traceable, tested, and
  within scope.
...
- [ ] Every Topic 12 requirement implemented (no silent omissions).
...
```text
feature/topic-12-opportunity-discovery
```
...
```text
feat(topic-12): <concise description>
```
